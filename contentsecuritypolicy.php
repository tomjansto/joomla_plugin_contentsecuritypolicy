...
class plgSystemContentSecurityPolicy extends JPlugin {
    ...
    public function __construct($subject, $config) {
        ...
        if ( $connect_src_enable ) {
            $tag_content_string .= "connect-src " . $connect_src . "; ";
        }
        ...
        if ( $font_src_enable ) {
            $tag_content_string .= "font-src " . $font_src . "; ";
        }
        ...
        if ( $frame_src_enable ) {
            $tag_content_string .= "frame-src " . $frame_src . "; ";
        }
        ...
        if ( $img_src_enable ) {
            $tag_content_string .= "img-src " . $img_src . "; ";
        }
        ...
        if ( $manifest_src_enable ) {
            $tag_content_string .= "manifest-src " . $manifest_src . "; ";
        }
        ...
        if ( $media_src_enable ) {
            $tag_content_string .= "media-src " . $media_src . "; ";
        }
        ...
        if ( $object_src_enable ) {
            $tag_content_string .= "object-src " . $object_src . "; ";
        }
        ...
        if ( $script_src_enable ) {
            $tag_content_string .= "script-src " . $script_src . "; ";
        }
        ...
        if ( $style_src_enable ) {
            $tag_content_string .= "style-src " . $style_src . "; ";
        }
        ...
        if ( $worker_src_enable ) {
            $tag_content_string .= "worker-src " . $worker_src . "; ";
        }
